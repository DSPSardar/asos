...
module.exports = {
  ...
  // 4096 truncated Planner mid-JSON in testing, then 8192 truncated web-search Scout
  // (search-result blocks count toward output tokens). 16384 gives real headroom; the
