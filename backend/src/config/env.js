...
const envSchema = z.object({
  ...
  // DSP enrolment source — the dsp-mastery Supabase project. Replaces the old
  // DSP_DB_* MariaDB block, which pointed at a local dev database that never
  // existed in production.
  DSP_SUPABASE_URL:        z.string().optional(),
  DSP_SUPABASE_SERVICE_KEY: z.string().optional(),
