// src/pages/AutomationsDemo.jsx — canned Automations walkthrough for the demo session ONLY.
// Real tenants render AutomationsLive.jsx (backed by /api/v1/automations).
